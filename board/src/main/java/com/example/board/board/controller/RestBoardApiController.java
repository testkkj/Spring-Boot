...
public class RestBoardApiController {
    ...
    public ModelAndView openBoardDetAndView(@PathVariable("boardIdx") int boardIdx) throws Exception {
    ...
    public String delteBoard(@PathVariable("boardIdx") int boardIdx) throws Exception {
